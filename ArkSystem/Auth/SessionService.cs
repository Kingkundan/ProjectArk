...
namespace ArkSystem.AuthServices
{
    public class SessionService
    {
        ...
        public async Task<bool> InvalidateRefreshToken(string refreshToken, string userName)
        {
            var token = await _context.Users
                .FirstOrDefaultAsync(t => t.RefreshToken == refreshToken && t.Username == userName);
            ...
            token.LastActivity = DateTime.Now;
            token.SessionTime = DateTime.Now-token.LastLogin;
            await _context.SaveChangesAsync();
